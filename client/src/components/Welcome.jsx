...
const Welcome = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // destruction properties of formData
        const {addressTo, amount, keyword, message} = formData;

        // usually the page reloads, when a form is submit, in react we want to prevent this behavior
        e.preventDefault();
            ...
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12">
                        Explore the Crypto World. Buy and Sell Cryptocurrency.
                    </p>
